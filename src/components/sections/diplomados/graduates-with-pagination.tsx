...
import { DiplomaList } from "@/components/ui/graduate/diploma-list";
          ...
          {loading ? (
            ...
            >
              {viewMode === "grid" ? (
                ...
                <DiplomaListSkeleton count={GRADUATES_PER_PAGE} />
              )}
            </motion.div>
          ) : (
            <motion.div
            ...
            >
              {viewMode === "grid" ? (
                ...
                <DiplomaList countryCode={countryCode} diplomas={graduates} />
              )}
            </motion.div>
          )}
          ...
          {!loading && totalPages > 1 && isMounted && (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() =>
                    ...
                    loadGraduatesPage(currentPage + 1)
                  }
              ...
              <div className="hidden sm:block text-sm text-gray-600 dark:text-gray-400 ml-4">
                ...
                {Math.min(currentPage * GRADUATES_PER_PAGE, pagination.total)}{" "}
                de {pagination.total} diplomados
              </div>
            </motion.div>
          )}
