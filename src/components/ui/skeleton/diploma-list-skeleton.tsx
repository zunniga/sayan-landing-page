...
interface DiplomaListSkeletonProps {
  count?: number;
}

export function DiplomaListSkeleton({ count = 6 }: DiplomaListSkeletonProps) {
  return (
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="relative h-48 sm:h-auto sm:w-48 flex-shrink-0 bg-gray-200 dark:bg-gray-700 overflow-hidden">
              ...
              <div className="absolute top-4 right-4">
                <div className="h-7 w-20 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
              </div>
